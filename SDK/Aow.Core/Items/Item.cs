...
namespace Aow2.Items
{
	...
	public class Item
	{
		...
		[Field( 0x2a )] public ItemType Type { get; set; }
		[Field( 0x22 )] public Availability Availability { get; set; }

		[Field( 0x26 )] public byte Damage { get; set; }
		[Field( 0x27 )] public byte Attack { get; set; }
		[Field( 0x28 )] public byte Resistance { get; set; }
		[Field( 0x29 )] public byte Defense { get; set; }

		[Field( 0x1f )] public ItemAbilityList Abilities { get; set; }

		[Field( 0x2b )] public Spirits RewardingSpirits { get; set; }

		[Field( 0x20 )] public int GoldCost { get; set; }
		[Field( 0x21 )] public int ImageIndex { get; set; }
		[Field( 0x24 )] public int CreationIndex { get; set; }


		[Field( 0x1e )] public int UnknownInt1E { get; set; }

		[Field( 0x23 )] private ShortPascalString _name = "";
		[Field( 0x25 )] private ShortPascalString _libraryName = "";
