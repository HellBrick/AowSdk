...
namespace Aow2.Maps.Events.Actions
{
	...
	public class DiplomaticActionEvent : Event
	{
		...
		public override string ToString() => base.ToString() + String.Format( " [Diplomacy] {0} -> {1}: {2}", PlayerNumberToName( FromPlayerNumber ), PlayerNumberToName( ToPlayerNumber ), Action );
	}
